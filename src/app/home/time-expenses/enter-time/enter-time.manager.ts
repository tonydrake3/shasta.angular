...
export class EnterTimeManager {
    ...
    private buildHoursToSubmit (date, employee, lines): LineToSubmit {
        ...
        return {
            ...
            Employee: employee,
            Project: _.cloneDeep(lines.selectedProject),
            CostCode: lines.selectedCostCode ? _.cloneDeep(lines.selectedCostCode) : '',
            System: lines.selectedSystem ? _.cloneDeep(lines.selectedSystem) : '',
            Phase: lines.selectedPhase ? _.cloneDeep(lines.selectedPhase) : '',
            IsPunch: false,
